...
public class Ajouter extends javax.swing.JDialog {
    ArrayList<Parrain> ListP = new ArrayList<>();
    ArrayList<Etudiant> ListF = new ArrayList<>();

    String nom="", prenom="", matricule="", filiere="", email="";
    public File img = new File("default_img.jpg"), f = null;
    int Xmou, Ymou, niveau=0;
    public int vrf = 0;
    String p;
     ...
     */
    public Ajouter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setResizable(false);
        setLocationRelativeTo(Acc);
        
        PlaceHolder p = new PlaceHolder(lbl_Matricule, new Color(200,200,200), Color.black,
                "Ex: 1718MY7O", false, "Agency FB", 16);
       p = new PlaceHolder(lbl_Nom, new Color(200,200,200), Color.black,
                "Entrer le nom", false, "Agency FB", 16);
       p = new PlaceHolder(lbl_prenom, new Color(200,200,200), Color.black,
                "Entrer le prenom", false, "Agency FB", 16);
      p = new PlaceHolder(lbl_Email, new Color(200,200,200), Color.black,
                "Ex: monemail@isj.com", false, "Agency FB", 16);
      connectToDnD();
      
    }
    
    public Ajouter(java.awt.Frame parent, boolean modal, 
         String nom, String prenom, String matr, String Fil, String mail, int niv, File fimg) {
...
//        System.out.println(img.getPath());
    ...
    private static boolean verifInfo(String nom, String prenom, String matricule, String email) {
        ...
        if( WriteString(nom).equals("Entrer le nom") || WriteString(prenom).equals("Entrer le prenom") || WriteString(matricule).equals("Ex: 1718MY7O")
            ...
            JOptionPane.showMessageDialog(null, "Les Champs Suivant: Matricule , Nom, Prenom et Email\n ne doivent pas etre vide.", 
    ...
    private void initComponents() {
        ...
        lbl_prenom.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                lbl_prenomlbl_MatriculeFocusGained(evt);
            }
        });
    ...
    private void lbl_prenomlbl_MatriculeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_lbl_prenomlbl_MatriculeFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_lbl_prenomlbl_MatriculeFocusGained
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Ajouter dialog = new Ajouter(new javax.swing.JFrame(), true);
